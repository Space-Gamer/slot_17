...
def train():
    ...
    for episode in range(300):
        ...
        if visualize:
            teleport_turtle(row_index, column_index)
            clear_path()
...
start_pos_x = int(input("Please enter start x coordinate: "))
start_pos_y = int(input("Please enter start y coordinate: "))

while [start_pos_x, start_pos_y] in obstacles:
    print("Invalid starting location. Please choose another location.")
    start_pos_x = int(input("Please enter start x coordinate: "))
    start_pos_y = int(input("Please enter start y coordinate: "))
...
visualize = input("Do you want to visualize the training? (y/n): ").lower() == 'y'
